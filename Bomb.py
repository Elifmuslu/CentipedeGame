...
class Bomb(pygame.sprite.Sprite):
    ...
    def __init__(self):
        ...
        self.imgSize=(20,20)
        self.image=pygame.image.load("bomba1.png")
        self.gif.append(pygame.image.load("bomba1.png"))
        self.gif.append(pygame.image.load("bomba2.png"))
        self.gif.append(pygame.image.load("bomba3.png"))
        self.gif.append(pygame.image.load("bomba4.png"))
